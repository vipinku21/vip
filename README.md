...
*   **Direct GitHub Commits (Auto-Save)**: When authorized, any configuration changes (add, edit, delete, reset) are committed directly back to the `policy.json` file in your GitHub repository.
...
*   Click **Save & Verify Connection**. Once verified, the status indicator in the top-right will turn blue and display *"Connected to GitHub"*.
